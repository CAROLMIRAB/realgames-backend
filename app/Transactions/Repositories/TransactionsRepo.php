...
class TransactionsRepo
{
    ...
    public function advancedSearch($client, $startDate, $endDate, $idtransaction, $username, $idgame, $gamename, $timezone)
    {
        ...
        $conditions = " where transactions.client = '$client' AND (transactions.created_at::TIMESTAMP WITH TIME ZONE AT TIME ZONE '$timezone')::DATE BETWEEN '$startDate' AND '$endDate'";
...
");
    ...
    public function totalSpinsByUser($user, $client)
    {

        $games = Transaction::select(\DB::raw('COUNT(*) as spin'))
