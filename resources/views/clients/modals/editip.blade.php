    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-ip" name="form-ip" method="post"  class="hidden" action="{{ route('clients.editip') }}">
                        <ol class="ips">
                    ...
                    <div class="modal-footer">
                        <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-success left" id="accept">{{ __('Aceptar') }}</button>
                        </div>
                    </div>
