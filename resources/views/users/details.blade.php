    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div class="box  details-user" data-route="{{ route('users.detailsdata', $user) }}">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item">
                                ...
                                <a class="pull-right x-editable dni" href="#" id="dni" name="dni"
                                   data-type="text"
                                   data-pk="{{ $user }}" data-url="{{ route('users.edit', [$user]) }}"
                                   data-title="DNI"></a>
                            </li>
                            <li class="list-group-item">
                                <b>{{ __('Nombres') }}</b>
                        ...
                        <table id="transactions"
                            ...
                            <tr role="row">
                                <th aria-label="Name: activate to sort column ascending" style="width: 304px;"
                                    ...
                                    class="sorting" width="10%">{{ __('Fecha') }}</th>
                                <th class="sorting" width="10%">{{ __('Transacción') }}</th>
                                <th class="sorting" width="10%">{{ __('Transacción de Cliente') }}</th>
                                <th class="sorting" width="15%">{{ __('Juego') }}</th>
                                <th class="sorting" width="15%">{{ __('Debito') }}</th>
                                <th class="sorting" width="15%">{{ __('Credito') }}</th>
                                <th class="sorting" width="25%">{{ __('Saldo Actual') }}</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
