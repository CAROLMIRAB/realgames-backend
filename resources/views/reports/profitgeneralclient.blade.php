    ...
    <section class="content">
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12 totals-profit"
                 data-route="{{ route('reports.profitgeneralclientstotals') }}">
                <div class="info-box">
...
@section('scripts')
    ...
    <script>
        $(function () {
            ...
            Reports.dataTableProfitClients();
        });
    </script>
@endsection