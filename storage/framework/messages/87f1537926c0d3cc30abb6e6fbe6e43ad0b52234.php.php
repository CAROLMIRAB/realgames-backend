    ...
    public function clientDataTable($clients)
    {
        ...
        foreach ($clients as $client) {
            ...
            $datatableclient->push([
                ...
                'rol' => $client->rol,
                'status' => $client->status,
                'details' => "<a class='send-mail label label-warning' data-loading-text=".__("Enviando...")." data-id='" . $client->id . "' data-name='" . $client->name . "' data-username='" . $client->username . "' data-email='" . $client->email . "' data-route='" . $route . "'>". __("Enviar Contraseña") ."<i class='fa fa-envelope-o'></i></a>",
            ]);
