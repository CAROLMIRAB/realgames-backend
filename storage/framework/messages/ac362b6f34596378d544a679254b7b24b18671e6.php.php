...
class ReportsCollection
{
    public function dataProfit($purchase, $won)
    {
        ...
        $response = [
            ...
            'data' => [
                'purchase' => $currency['symbol'] . " " . number_format($purchase, intval($currency['decimals']), $currency['decimalseparator'], $currency['thousandseparator']),
                'won' => $currency['symbol'] . " " . number_format($won, intval($currency['decimals']), $currency['decimalseparator'], $currency['thousandseparator']),
