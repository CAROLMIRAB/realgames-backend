<?php $__env->startSection('content'); ?>
    ...
    <section class="content">
        <?php echo $__env->make('core.client.dashboardresume2', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php echo $__env->make('core.client.dashboardgraphic', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </section>
