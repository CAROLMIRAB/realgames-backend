                            ...
                            <div class="page-toolbar">
                                <div class="pull-left">
                                    <select class="form-control" id="provider" name="provider">
                                        <option value="netent"><?php echo e(__('Nentent')); ?></option>
                                        <option value="playtech"><?php echo e(__('Playtech')); ?></option>
                                        <option value="amatic"><?php echo e(__('Amatic')); ?></option>
                                        <option value="novomatic"><?php echo e(__('Novomatic')); ?></option>
                                    </select>
                                </div>
                            </div>
