            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?php echo e(asset('admin-lte/dist/img/avatar5.png')); ?>" class="user-image" alt="User Image">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="<?php echo e(route('clients.details')); ?>" class="btn btn-default btn-flat"><?php echo e(__('Perfil')); ?></a>
                            </div>
                            <div class="pull-right">
                                <a href="<?php echo e(route('clients.logout')); ?>" class="btn btn-default btn-flat"><?php echo e(__('Salir')); ?></a>
                            </div>
                        </li>
                    </ul>
                </li>
